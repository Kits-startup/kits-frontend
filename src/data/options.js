...
export const type_region = [
  ...
  { value: "daego", text: "대구" },
  { value: "daejun", text: "대전" },
  { value: "junrado", text: "전라도" },
  { value: "busan", text: "부산" },
...
export const specific_region_seoul = [
  { value: "seocho", text: "서초구" },
  { value: "gangnam", text: "강님구" },
  { value: "gangbook", text: "강북구" },
  { value: "gangseo", text: "강서구" },
  { value: "gangdong", text: "강동구" },
  { value: "jungrang", text: "중랑구" },
...
export const specific_region_incheon = [
  { value: "namgong", text: "남동구" },
  { value: "bupyeong", text: "부평구" },
  { value: "geyang", text: "계양구" },
  { value: "yeonsoo", text: "연수구" },
  { value: "gumdan", text: "검단구" },
  { value: "seo", text: "서구" },
];
